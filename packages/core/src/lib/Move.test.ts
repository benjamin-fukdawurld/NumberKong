...
describe('Move', () => {
  ...
  it('serialization', () => {
    ...
    expect(new Move('r12c13 r21c22').toJSON()).toEqual(
      JSON.stringify('r12c13 r21c22')
    );
  });

  it('serialization', () => {
    expect(Move.fromString('r12c13 r21c22').toString()).toEqual(
      'r12c13 r21c22'
    );
    expect(Move.fromJSON(JSON.stringify('r12c13 r21c22')).toString()).toEqual(
      'r12c13 r21c22'
    );
  });

  it('assign', () => {
    expect(new Move().assign('r12c13 r21c22').toString()).toEqual(
      'r12c13 r21c22'
    );
    expect(new Move().assign(['r12c13', 'r21c22']).toString()).toEqual(
      'r12c13 r21c22'
    ...
    expect(
      new Move().assign(['r12c13'.split(''), 'r21c22'.split('')]).toString()
    ).toEqual('r12c13 r21c22');
  });
});
